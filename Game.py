...
class Game:
    def __init__(self):
        ...
        """
        # Assets (images)
        self.imgBackground = cv2.imread("Images/Background.png")
        self.asteroid_img = cv2.imread("Images/Asteroid_img.png", cv2.IMREAD_UNCHANGED)
        self.spaceship_img = cv2.imread("Images/spaceship_img.png", cv2.IMREAD_UNCHANGED)
